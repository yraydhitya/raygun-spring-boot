...
public class RaygunWebMvcConfiguration {
  ...
  @Bean
  @ConditionalOnMissingBean(RaygunExceptionResolver.class)
  HandlerExceptionResolver raygunExceptionResolver(RaygunTemplate raygunTemplate) {
    return new RaygunExceptionResolver(raygunTemplate);
  }
}
